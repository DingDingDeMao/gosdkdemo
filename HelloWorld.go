...
const HelloWorldABI = "[{\"constant\":true,\"inputs\":[],\"name\":\"getName\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_name\",\"type\":\"string\"}],\"name\":\"setName\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"_name\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// HelloWorldBin is the compiled bytecode used for deploying new contracts.
var HelloWorldBin = ""

// DeployHelloWorld deploys a new contract, binding an instance of HelloWorld to it.
func DeployHelloWorld(auth *bind.TransactOpts, backend bind.ContractBackend, _name string) (common.Address, *types.Transaction, *HelloWorld, error) {
	parsed, err := abi.JSON(strings.NewReader(HelloWorldABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}

	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(HelloWorldBin), backend, _name)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func AsyncDeployHelloWorld(auth *bind.TransactOpts, handler func(*types.Receipt, error), backend bind.ContractBackend, _name string) (*types.Transaction, error) {
	parsed, err := abi.JSON(strings.NewReader(HelloWorldABI))
	if err != nil {
		return nil, err
	}

	tx, err := bind.AsyncDeployContract(auth, handler, parsed, common.FromHex(HelloWorldBin), backend, _name)
	if err != nil {
		return nil, err
	}
	return tx, nil
...
func (_HelloWorld *HelloWorldCaller) GetName(opts *bind.CallOpts) (string, error) {
	var (
		ret0 = new(string)
	)
	out := ret0
	err := _HelloWorld.contract.Call(opts, out, "getName")
	return *ret0, err
}
...
//
// Solidity: function getName() constant returns(string)
func (_HelloWorld *HelloWorldSession) GetName() (string, error) {
	return _HelloWorld.Contract.GetName(&_HelloWorld.CallOpts)
}

// GetName is a free data retrieval call binding the contract method 0x17d7de7c.
//
// Solidity: function getName() constant returns(string)
func (_HelloWorld *HelloWorldCallerSession) GetName() (string, error) {
	return _HelloWorld.Contract.GetName(&_HelloWorld.CallOpts)
}
...
func (_HelloWorld *HelloWorldTransactor) SetName(opts *bind.TransactOpts, _name string) (*types.Transaction, *types.Receipt, error) {
	return _HelloWorld.contract.Transact(opts, "setName", _name)
}

func (_HelloWorld *HelloWorldTransactor) AsyncSetName(handler func(*types.Receipt, error), opts *bind.TransactOpts, _name string) (*types.Transaction, error) {
	return _HelloWorld.contract.AsyncTransact(opts, handler, "setName", _name)
}

// SetName is a paid mutator transaction binding the contract method 0xc47f0027.
//
// Solidity: function setName(string _name) returns()
func (_HelloWorld *HelloWorldSession) SetName(_name string) (*types.Transaction, *types.Receipt, error) {
	return _HelloWorld.Contract.SetName(&_HelloWorld.TransactOpts, _name)
}

func (_HelloWorld *HelloWorldSession) AsyncSetName(handler func(*types.Receipt, error), _name string) (*types.Transaction, error) {
	return _HelloWorld.Contract.AsyncSetName(handler, &_HelloWorld.TransactOpts, _name)
}

// SetName is a paid mutator transaction binding the contract method 0xc47f0027.
//
// Solidity: function setName(string _name) returns()
func (_HelloWorld *HelloWorldTransactorSession) SetName(_name string) (*types.Transaction, *types.Receipt, error) {
	return _HelloWorld.Contract.SetName(&_HelloWorld.TransactOpts, _name)
}

func (_HelloWorld *HelloWorldTransactorSession) AsyncSetName(handler func(*types.Receipt, error), _name string) (*types.Transaction, error) {
	return _HelloWorld.Contract.AsyncSetName(handler, &_HelloWorld.TransactOpts, _name)
}
